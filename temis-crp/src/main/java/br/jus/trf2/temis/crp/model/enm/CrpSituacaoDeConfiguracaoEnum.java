...
public enum CrpSituacaoDeConfiguracaoEnum implements IEnumWithId {
	...
	CrpSituacaoDeConfiguracaoEnum(int id, String descr, int restritividade) {
		this.id = id;
		this.descr = descr;
	...
	public static CrpSituacaoDeConfiguracaoEnum getById(Integer id) {
		return IEnumWithId.getEnumFromId(id, CrpSituacaoDeConfiguracaoEnum.class);
	}
