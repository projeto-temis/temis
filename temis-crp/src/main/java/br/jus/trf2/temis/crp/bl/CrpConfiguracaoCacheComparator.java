...
public class CrpConfiguracaoCacheComparator implements Comparator<CrpConfiguracaoCache> {

	public int compareSelectedFields(CrpConfiguracaoCache c1, CrpConfiguracaoCache c2) {
...
//
	...
	//
	public int untieSelectedFields(CrpConfiguracaoCache c1, CrpConfiguracaoCache c2) {
...
//			return Long.compare(c1.cpGrupo, c2.cpGrupo);
	...
	public int compare(CrpConfiguracaoCache c1, CrpConfiguracaoCache c2) {
