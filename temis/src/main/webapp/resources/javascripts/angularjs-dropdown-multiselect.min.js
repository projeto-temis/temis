	...
	return {
		...
		link : function($scope, $element, $attrs) {
			...
			$scope.setSelectedItem = function(id, dontRemove) {
				...
				if ($scope.settings.externalIdProp === 'strings') {
					finalObj = id;
				} else if ($scope.settings.externalIdProp === '') {
				...
				if (typeof finalObj === 'string')
					exists = ($scope.selectedModel.indexOf(finalObj) > -1);
				else
					exists = _.findIndex($scope.selectedModel, findObj) !== -1;
