          ...
          <tbody>
            <template v-for="f in filtrados">
              ...
              <tr v-bind:class="{ odd: f.odd }" :key="'grupo-row' + f.codigo">
                ...
                <td>
                  <router-link
                    :to="{ name: f.tipo + 'Show', params: { key: f.codigo } }"
                    >{{ f.sigla }}</router-link
                ...
                <td class="d-none d-md-block" style="padding: 0;">
                  <div class="xrp-label-container">
                    ...
                    <span v-for="m in f.list" :title="m.titulo" :key="m.id"
