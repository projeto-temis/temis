...
@NamedQueries({
		@NamedQuery(name = "consultarDataUltimaAtualizacao", query = ""
				...
				+ "from CrpConfiguracaoCache cpcfg"),
		@NamedQuery(name = "consultarCacheDeConfiguracoesAtivas", query = " from "
				+ "CrpConfiguracaoCache cpcfg where cpcfg.cpTipoConfiguracao in :tipos and cpcfg.hisDtFim is null") })

@Entity
@Table(name = "corporativo.cp_configuracao")
@Inheritance(strategy = InheritanceType.JOINED)
public class CrpConfiguracaoCache {
...
//	public String descrConfiguracao;
	...
	public CrpTipoDeConfiguracaoInterface cpTipoConfiguracao;
...
//	public CpPerfil cpPerfil;
	...
	public CrpSituacaoDeConfiguracaoEnum situacao;
