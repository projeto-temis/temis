...
public class TemisDownload implements Download, Serializable {
	public byte[] bytes;
	...
	public TemisDownload(byte[] bytes, String contentType, String fileName) {
		this(bytes, contentType, fileName, false, null, false, null);
	}

	public TemisDownload(byte[] bytes, String contentType, String fileName, boolean doDownload, String etag,
